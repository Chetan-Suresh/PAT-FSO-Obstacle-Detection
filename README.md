...
The system includes Pan and Tilt mechanism (PAT) to maintain laser alignment and uses obstacle detection to stop audio transmission when the line-of-sight is blocked.
